      ...
      <div className="mt-6 rounded-2xl border border-[#FDE68A] bg-[#FFFAEB] p-6 text-sm">
        ...
        <div className="mt-3 space-y-3 text-[#78350F]">
          ...
          <div>
            ...
            <div className="mt-1 text-[#7C5A00]">This happens when Kite refuses to redirect back — usually because the redirect URL on the app doesn&apos;t exactly match this callback: <code className="bg-white/60 rounded px-1 break-all">{window.location.origin}/broker/kite/callback</code>. Update it in your app settings.</div>
          </div>
          <div>
