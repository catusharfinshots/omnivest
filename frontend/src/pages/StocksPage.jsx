          ...
          {filtered.map(s => (
            <div key={s.symbol} className="grid grid-cols-12 px-5 py-4 items-center text-sm hover:bg-[#FBF8FF] transition-colors">
              <div className="col-span-5 flex items-center gap-3">
                <div className="h-9 w-9 rounded-lg bg-[#F1E7FE] text-[#5320A8] grid place-items-center text-[10px] font-bold">{s.symbol.slice(0,2)}</div>
                <div>
              ...
              <div className={`col-span-1 num text-right font-semibold flex items-center justify-end gap-1 ${s.change >= 0 ? 'text-[#12B76A]' : 'text-[#F04438]'}`}>
